      ...
      return(
        <div className="blocks" key={index}>
          <div className="first-block">
            ...
            {story.writer.image ? <img src={story.writer.image}  alt="p-img"/> : story.writer.fname ? <div className="img-nm"> {story.writer.fname.slice(0,1) + '.' + story.writer.lname.slice(0,1) + '.'} </div> : <div className="img-nm">&nbsp; &nbsp;?</div>}
            </NavLink>
...
render() {
  ...
  if(this.props.stories) {
    if(this.props.stories.length > 0) {
      return(
      <div>
        {this.renderStories(this.props.me,this.props.stories)}
