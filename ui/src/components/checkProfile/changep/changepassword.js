...
class Changepassword extends Component {
  ...
  submit(e) {
    ...
    if(this.state.opwd === '') {
      ...
      this.setState({msg:'Please Provide Your Old Password.'});
      this.clearMsg();
  ...
  return(
    ...
    <div className="box">
      ...
      <input name="oldpassword" className="form-group" type="password"  value={this.state.opwd} onChange={(e)=>this.setState({opwd:e.target.value})}/>
      </div>
